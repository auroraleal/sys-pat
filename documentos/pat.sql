...
CREATE TABLE IF NOT EXISTS `pat`.`iniciativa` (
  ...
  `justificativa_nao_executadas` TEXT NULL,
  `metas_extras` TEXT NULL,
  PRIMARY KEY (`id`),
...
-- Table `pat`.`metas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pat`.`metas` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `quadrimestre` TINYINT NOT NULL,
  `percentual_planejado` TINYINT NOT NULL,
  `percentual_executado` TINYINT NOT NULL,
  `iniciativa_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_metas_iniciativa1_idx` (`iniciativa_id` ASC),
  CONSTRAINT `fk_metas_iniciativa1`
...
-- -----------------------------------------------------
-- Table `pat`.`dotacao_orcamentaria`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pat`.`dotacao_orcamentaria` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `quadrimestre` TINYINT NOT NULL,
  `valor_inicial` TINYINT NOT NULL,
  `valor_atual` TINYINT NOT NULL,
  `acao_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_dotacao_orcamentaria_acao1_idx` (`acao_id` ASC),
  CONSTRAINT `fk_dotacao_orcamentaria_acao1`
    FOREIGN KEY (`acao_id`)
    REFERENCES `pat`.`acao` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
