...
$stmt = $conn->prepare("SELECT i.id, i.descricao FROM iniciativa i WHERE i.acao_id = $acao_id;");
$stmt->execute();
...
<head>
  ...
  <link rel="stylesheet" href="/sys-pat/assets/css/dataTables.jqueryui.css">
  <!-- Font Awesome -->
  ...
  <div class="content-wrapper">
        ...
        <section class="content">
          <div class="row">
            ...
            <div class="col-xs-12">
              <?php
                echo "<a href='nova.php?id=$acao_id' class='btn btn-success' style='margin-bottom: 20px; margin-top: 20px'><i class='fa fa-plus-square'></i></a>";
              ?>
            </div>
            <!-- /.box-header -->
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                <h3 class="box-title"><b>Lista das Iniciativas</b></h3> <br/><br/>
                <h3 class="box-title"><b>Ação: <?php echo $nome ?></b></h3>
            ...
            <div class="box-body">
              <table id="tabela" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  ?>
                  <td align='center'><a onclick="return confirm('Deseja realmente excluir?');" href='../../controllers/pat/excluir.php?id=<?=$id?>' class='btn btn-danger'><i class='fa fa-trash'></i></a>
                  <?php     
