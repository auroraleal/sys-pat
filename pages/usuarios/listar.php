...
$stmt = $conn->prepare("SELECT u.id, u.nome, u.email, p.nome as perfil, u.senha FROM usuario u INNER JOIN perfil p ON u.perfil_id = p.id ;");
$stmt->execute();
                  ...
                  <?php
                    ...
                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC))
                    {
                      ...
                      echo '<tr>';
                        ...
                        echo "<td align='center'>" . "<a href='../../controllers/usuario/excluir.php?id=$id' class='btn btn-danger'><i class='fa fa-trash'></i></a>";
