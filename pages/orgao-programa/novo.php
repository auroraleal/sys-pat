    	...
    	<div style="margin-left: 100px" class="col-md-10">
          <!-- general form elements -->
            ...
            <div id="orgao" class="col-md-10" style="margin-bottom: 20px">
              ...
              <h5>Unidade Orçamentária: <b><?php echo $results['unidade_orcamentaria']?></b></h5>
            </div>
            <div class="col-md-3">
                    ...
                    while ($row = $stmt_programas_vinculados->fetch(PDO::FETCH_ASSOC))
                    {
                      ...
                      echo '<tr>';
                        ...
                        ?>
                          ...
                          <a onclick="return confirm('Deseja realmente desvinclar programa?');" href='../../controllers/orgao-programa/excluir.php?orgao=<?=$orgao_id?>&programa=<?=$programa_id?>' class='btn btn-danger'><i class='fa fa-trash'></i></a>
                      <?php                          
                        echo '</td>';
                      echo '</tr>';
                    }
